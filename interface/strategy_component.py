...
class StrategyEditor(tk.Frame):
    def __init__(self, root, binance: BinanceFuturesClient, *args, **kwargs):
        ...
        self._headers = ["Startegy", "Contract", "Timeframe", "Balance %", "TP %", "SL %"]
        ...
        self._base_params = [
            ...
            {"code_name": "activation", "widget": tk.Button, "data_type": float, "text": "OFF", "bg": BG_COLOR_2,
             "command": self._switch_strategy},
            {"code_name": "delete", "widget": tk.Button, "data_type": float, "text": "X", "bg": BG_COLOR_2,
        ...
        for p in self._base_params:
            self.body_widgets[p['code_name']] = {}
            if p["widget"] == tk.OptionMenu:
                self.body_widgets[p['code_name'] + "_var"] = {}
